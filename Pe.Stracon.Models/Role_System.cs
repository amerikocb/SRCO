...
namespace Pe.Stracon.Models
{
    ...
    public partial class Role_System
    {
        public int N_ID_ROLE_SYSTEM { get; set; }
        public Nullable<int> N_ID_SYSTEM { get; set; }
        public Nullable<int> N_ID_ROLE { get; set; }
        ...
        public virtual SystemSRA SystemSRA { get; set; }
    }
}
